...
#### 3）mysql.yaml
根据自身情况，可配置多个项目多个环境的业务mysql连接信息和框架使用的用例mysql连接信息
    ...
    BlogProject:                      # 项目名
      TEST:                           # 测试环境
        business_db_1:                # 业务库1，禁止修改此名称
          - 127.0.0.1
          - 3306
          - root
          - 123456
        business_db_2:                # 业务库2，禁止修改此名称
          - 127.0.0.1
          - 3306
          - root
          - 123456
...
#### 4）redis.yaml
根据自身情况，可配置多个项目多个环境的业务redis的连接信息和框架使用的redis连接信息
...
> ## 用例代码
上方第四点内已说明用例代码编写模板，用例代码涉及了报告的信息和用例的编排，此处针对用例id写法进行详细说明
